...
function Enrollment() {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      const payload = {
        ...
        amount: getEnrollmentAmount(values.enrollmentType),
  ...
  return (
    <div className="w-full rounded-2xl mb-5 bg-white p-5 shadow-lg">
      <ToastContainer />
      <p className="text-3xl text-center text-amber-600 font-semibold">
        Enrollment
      </p>
      <div className="ml-7">
        ...
        <Form form={form} onFinish={onFinish} layout="vertical" className="">
          ...
          >
            <Select placeholder="-- Select an Option --">
              <Select.Option value="adult">
                Adult Enrollment @ ₦20,000
              </Select.Option>
              <Select.Option value="child">
                Child Enrollment @ ₦15,000
              </Select.Option>
            </Select>
          </Form.Item>
          ...
          <Row gutter={16}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item
                ...
                label="LGA OF ORIGIN"
                rules={[
                  { required: true, message: "Please select LGA of origin" },
                ]}
              >
          ...
          <Form.Item size="large">
            <Button
              ...
              size="large"
              htmlType="submit"
              className="w-full flex items-center  mt-[-5px]"
              loading={loading}
