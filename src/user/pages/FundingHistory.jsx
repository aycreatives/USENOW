...
export default function VerificationsHistoryTable() {
  ...
  const apiLink = `${config.apiBaseUrl}${config.endpoints.walletBalance}${userId}`;
  ...
  const fetchVerificationHistory = async () => {
    ...
    try {
      ...
      console.log("Response data:", response.data?.wallet?.transactions || []);
      setApiData(response.data?.wallet?.transactions || []);
    } catch (error) {
