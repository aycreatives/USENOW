  ...
  return (
    <>
      <div className="w-full rounded-2xl mb-10 bg-white p-5 shadow-lg">
        <p className="text-3xl font-bold text-amber-600 mb-5 text-center ">
          IPE CLEARANCE
        </p>
      ...
      >
        <div className="py-4 text-center">
          <h1 className="text-3xl font-bold text-[#529d3f] mb-5">
            IPE Clearance
          </h1>

          <>
            <p className="text-[17px] text-green-900 bg-green-100  p-3 rounded">
              Clearance request submitted successfully!
            </p>
            <p className="p-3 mb-5">
              You will be directed to check on your request status when you
              click on <span className="font-bold">View Status</span>.
            </p>
          </>
        </div>
      </Modal>
