...
const REGISTRATION_TYPES = [
  { value: "Business Name (BN)", label: "Business Name (BN)", price: 30000 },
  {
...
function CAC() {
  ...
  return (
    <div className="p-5 bg-white shadow rounded">
      ...
      <h2 className="text-2xl  font-semibold text-center mb-10 text-amber-600">
      ...
      >
        ...
        <div className="flex justify-between mt-8">
          {currentStep > 0 && (
            <Button
              onClick={prevStep}
              className="bg-[#529d3f] mr-4 w-[50%] ml-auto"
            >
              Previous
            </Button>
          )}
          {currentStep === 0 && (
            <Button
              type="primary"
              onClick={nextStep}
              className="bg-[#529d3f] w-[50%] ml-auto"
