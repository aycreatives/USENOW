...
function Personalisation() {
  ...
  const [personalisationPrice, setPersonalisationPrice] = useState(300); // Default price
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await Swal.fire({
      ...
      text: `Are you sure you want to proceed with this Submision? Amount: ₦${personalisationPrice}`,
      icon: "question",
    ...
    try {
      ...
      await Swal.fire({
        ...
        text: "Your Personalisation details has been submitted successfully.",
        icon: "success",
        confirmButtonColor: "#f59e0b",
      });
    } catch (error) {
          ...
          {cardVerify.map(({ label, value }) => (
            ...
            ${
              selectedVerify === value
                ? "border-amber-600 ring-2 ring-amber-200 shadow-lg"
