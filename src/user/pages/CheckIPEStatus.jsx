      ...
      <Modal
        ...
        footer={[
          <button
            ...
            className="flex justify-center border border-black font-medium py-2 px-4 rounded-xl bg-amber-500 textwhite hover:bg-amber-600 cursor-pointer text-white transition-colors"
          >
            View Status
          </button>,
        ]}
