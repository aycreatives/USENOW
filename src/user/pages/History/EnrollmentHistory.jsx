...
export default function EnrollmentHistory() {
  ...
  const apiLink = `${config.apiBaseUrl}${config.endpoints.enrollmentHistory}${userId}`;
      ...
      {!loading && sortedTransactions.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center p-8">
          <Empty
            ...
            description={<span>No Enrollment history records found.</span>}
          />
        </div>
      ) : null}
          ...
          <div className="flex flex-col md:flex-row gap-6 p-4">
            ...
            <div className="flex-shrink-0 w-full md:w-1/3 flex flex-col items-center text-center">
              {selectedTransaction.passport ? (
                <img
                  src={`data:image/jpeg;base64,${selectedTransaction.passport}`}
                  alt="Passport"
